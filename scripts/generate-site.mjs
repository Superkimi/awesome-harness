...
write(path.join(root, "README.zh.md"), [
  "# Awesome Harness",
  "",
  `独立维护的开源 Agent Harness 教程合集。当前包含 7 个本轮最新拉取的源码快照，以及 ${projects.filter((p) => p.legacy).length} 个从上一轮源码账本迁移的 legacy 项目。两类项目都明确记录 branch、commit 和源码行号；legacy 页面不会伪装成 2026-08 的最新 HEAD。`,
  "",
  "- 中文/English 单页技术分析",
  "- 10 章独立小白教程页面",
  "- 架构图、时序图、能力图（可点击节点）",
...
write(path.join(root, "README.en.md"), [
  "# Awesome Harness",
  "",
  `An independently maintained bilingual atlas of open-source Agent Harness projects. The current release contains seven freshly cloned source snapshots plus ${projects.filter((p) => p.legacy).length} legacy projects migrated from the previous source ledger. Both groups record branch, commit, and line-level citations; legacy pages are explicitly not presented as the latest 2026-08 HEAD. Every project includes:`,
  "",
